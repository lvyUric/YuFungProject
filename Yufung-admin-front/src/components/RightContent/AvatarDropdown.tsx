...
export const AvatarDropdown: React.FC<GlobalHeaderRightProps> = ({
  ...
  const menuItems = [
      ...
      ? [
          {
            ...
            label: intl.formatMessage({
              id: 'component.globalHeader.avatar.center',
              defaultMessage: '个人中心',
            }),
          },
          {
            ...
            label: intl.formatMessage({
              id: 'component.globalHeader.avatar.settings',
              defaultMessage: '个人设置',
            }),
          },
          {
            ...
            icon: <SettingOutlined />,
            label: intl.formatMessage({
              id: 'component.globalHeader.avatar.changePassword',
              defaultMessage: '修改密码',
            }),
          },
          {
      ...
      : []),
    {
      ...
      icon: <LogoutOutlined />,
      label: intl.formatMessage({
        id: 'component.globalHeader.avatar.logout',
        defaultMessage: '退出登录',
      }),
    },
  ];
